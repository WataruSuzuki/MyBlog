...
FLAGS = flags.FLAGS
# 学習用データ
flags.DEFINE_string('train', './datasets/train/data.txt', 'File name of train data')
# 検証用データ
flags.DEFINE_string('test', './datasets/test/data.txt', 'File name of train data')
# TensorBoardのデータ保存先フォルダ
flags.DEFINE_string('train_dir', './datasets', 'Directory to put the training data.')
# 学習訓練の試行回数
